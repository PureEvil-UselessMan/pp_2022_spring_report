...
\parТаким образом, была достигнута эффективность выполнения операции \\
...
\begin{lstlisting}
    Matrix Matrix::T()
\end{lstlisting}
\parОписание: реализует алгоритм транспонирования разреженной матрицы \\
...
\bibitem{Method}Compressed Column (CC) Sparse Matrix File Format \\
